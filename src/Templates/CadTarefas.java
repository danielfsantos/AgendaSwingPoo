...
public class CadTarefas extends javax.swing.JFrame {
    ...
    private static cadTarefasController cadControler = new cadTarefasController();
    ...
    public static void verifyCampos(String um,String dois , String tres ){
    
        if (cadControler.CampoIsNull(um, dois, tres)){
        JOptionPane.showMessageDialog(null,"vazio");
        }else {
            JOptionPane.showMessageDialog(null,"cheio");
