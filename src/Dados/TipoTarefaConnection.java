 ...
 * @author PauloPC
 */
public class TipoTarefaConnection extends AgendaConnection {
 public static void saveTipoTarefa(String nome) throws SQLException{
        String sql = "insert into tipoTarefa(Tarefa) values (?)";
        try {
